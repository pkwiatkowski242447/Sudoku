...
public class SudokuColumnTest {
    ...
    public void negativeVerificationDueToWrongValues() {
        SudokuBoard exampleSudokuBoard_1 = new SudokuBoard(incorrectBoard);
        assertFalse(exampleSudokuBoard_1.getColumn(1).verify());
        assertFalse(exampleSudokuBoard_1.getColumn(2).verify());
        assertFalse(exampleSudokuBoard_1.getColumn(3).verify());
    }
